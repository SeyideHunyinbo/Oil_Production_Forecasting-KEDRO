...
def train_test_split_data(all_wells_labels, parameters):  
    ...
    train_wells, test_wells, y_train_wells, y_test_wells = train_test_split(well_count_input, well_count_output, test_size=parameters["test_size"], random_state=parameters["random_state"])
