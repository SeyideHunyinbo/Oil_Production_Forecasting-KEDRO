...
#                 inputs=["all_wells_steam_input", "all_wells_emulsion_input", "properties", "all_wells_labels"],
#                 outputs=["X_validate", "y_validate", "X_validate2", "y_validate2"],
#                 name="train_validation_split"
#             ),
#             node(
#                 func=grid_search_tuning,
#                 inputs=["X_validate", "y_validate", "X_validate2", "y_validate2"],
#                 outputs="dummy2",
#                 name="grid_search_tuning"
#             ),
            node(
                func=train_test_split_data,
                inputs=["all_wells_labels", "parameters"],
                outputs=["train_wells", "test_wells"],
                name="train_test_split"
            ),
            node(
                func=augment_data_steam_oil,
                inputs=["train_wells", "test_wells", "all_wells_steam_input", "all_wells_emulsion_input", "properties", "all_wells_labels"],
                outputs=["X_train", "X_test", "X_train2",  "X_test2", "scheme_train"],
...
#             ),
            node(
                ...
                inputs=["train_wells", "test_wells", "all_wells_labels", "scheme_train"],
                outputs=["y_train", "y_test", "y_train2", "y_test2"],
