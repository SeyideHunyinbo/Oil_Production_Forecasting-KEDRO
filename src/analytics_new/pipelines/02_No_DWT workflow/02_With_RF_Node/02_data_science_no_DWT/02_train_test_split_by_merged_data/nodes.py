...
#     for file in files:
#         data_set_input = CSVLocalDataSet(filepath=parameters["path_primary"]+"/inputs_"+file)
#         inputs = data_set_input.load()
#         all_wells_input.append(inputs.values)
...
#         time_index = np.arange(len(well_label))    # may change
